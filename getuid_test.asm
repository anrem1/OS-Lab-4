...
_getuid_test:     file format elf32-i386
...
int main() {
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    int uid = getuid();
  11:	e8 05 03 00 00       	call   31b <getuid>
    printf(1, "User ID: %d\n", uid);
 ...
 338:	89 d1                	mov    %edx,%ecx
{
 ...
 36b:	0f b6 92 44 07 00 00 	movzbl 0x744(%edx),%edx
 ...
 3d9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 444:	ff 24 85 ec 06 00 00 	jmp    *0x6ec(,%eax,4)
 ...
 550:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 555:	bb e5 06 00 00       	mov    $0x6e5,%ebx
 ...
 561:	a1 e0 09 00 00       	mov    0x9e0,%eax
{
 ...
 59f:	5b                   	pop    %ebx
  freep = p;
 5a0:	a3 e0 09 00 00       	mov    %eax,0x9e0
}
 5a5:	5e                   	pop    %esi
 5a6:	5f                   	pop    %edi
 5a7:	5d                   	pop    %ebp
 ...
 5b6:	72 ce                	jb     586 <free+0x26>
{
 ...
 5d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5da:	a3 e0 09 00 00       	mov    %eax,0x9e0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 5f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 5fc:	8b 15 e0 09 00 00    	mov    0x9e0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 63b:	3b 05 e0 09 00 00    	cmp    0x9e0,%eax
 ...
 65e:	e8 fd fe ff ff       	call   560 <free>
  return freep;
 663:	8b 15 e0 09 00 00    	mov    0x9e0,%edx
 ...
 68c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 68f:	89 15 e0 09 00 00    	mov    %edx,0x9e0
}
 ...
 69f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6a0:	c7 05 e0 09 00 00 e4 	movl   $0x9e4,0x9e0
 6a7:	09 00 00 
    base.s.size = 0;
 6aa:	b8 e4 09 00 00       	mov    $0x9e4,%eax
    base.s.ptr = freep = prevp = &base;
 6af:	c7 05 e4 09 00 00 e4 	movl   $0x9e4,0x9e4
 6b6:	09 00 00 
    base.s.size = 0;
 6b9:	c7 05 e8 09 00 00 00 	movl   $0x0,0x9e8
 6c0:	00 00 00 
    if(p->s.size >= nunits){
