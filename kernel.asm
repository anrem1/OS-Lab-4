...
8010064b:	0f b6 92 a0 76 10 80 	movzbl -0x7fef8960(%edx),%edx
...
80100daf:	89 38                	mov    %edi,(%eax)
  curproc->pgdir = pgdir;
80100db1:	89 48 08             	mov    %ecx,0x8(%eax)
...
80101613:	68 b4 76 10 80       	push   $0x801076b4
...
80102068:	68 53 75 10 80       	push   $0x80107553
...
8010240a:	68 08 77 10 80       	push   $0x80107708
...
8010271b:	0f b6 91 80 79 10 80 	movzbl -0x7fef8680(%ecx),%edx
  shift ^= togglecode[data];
80102722:	0f b6 81 80 78 10 80 	movzbl -0x7fef8780(%ecx),%eax
  shift |= shiftcode[data];
...
80102738:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010273b:	8b 04 85 60 78 10 80 	mov    -0x7fef87a0(,%eax,4),%eax
...
80102775:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80102778:	0f b6 81 80 79 10 80 	movzbl -0x7fef8680(%ecx),%eax
...
801033d8:	68 3c 77 10 80       	push   $0x8010773c
...
80103814:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103817:	c7 40 14 88 58 10 80 	movl   $0x80105888,0x14(%eax)
  p->context = (struct context*)sp;
...
80103935:	68 5c 77 10 80       	push   $0x8010775c
...
8010399c:	89 c3                	mov    %eax,%ebx
  initproc = p;
8010399e:	a3 54 3d 11 80       	mov    %eax,0x80113d54
  if((p->pgdir = setupkvm()) == 0)
801039a3:	e8 b8 34 00 00       	call   80106e60 <setupkvm>
801039a8:	89 43 08             	mov    %eax,0x8(%ebx)
...
801039d3:	ff 73 1c             	push   0x1c(%ebx)
...
801039f2:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
801039f6:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80103a23:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a2a:	8d 43 70             	lea    0x70(%ebx),%eax
...
80103ac7:	ff 73 08             	push   0x8(%ebx)
...
80103ae7:	ff 73 08             	push   0x8(%ebx)
...
80103b50:	89 01                	mov    %eax,(%ecx)
  *np->tf = *curproc->tf;
80103b52:	8b 79 1c             	mov    0x1c(%ecx),%edi
  np->parent = curproc;
80103b55:	89 c8                	mov    %ecx,%eax
80103b57:	89 59 18             	mov    %ebx,0x18(%ecx)
  *np->tf = *curproc->tf;
80103b5a:	b9 13 00 00 00       	mov    $0x13,%ecx
80103b5f:	8b 73 1c             	mov    0x1c(%ebx),%esi
80103b62:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103b64:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
80103b66:	8b 40 1c             	mov    0x1c(%eax),%eax
...
80103b96:	ff 73 6c             	push   0x6c(%ebx)
...
80103beb:	ff 73 0c             	push   0xc(%ebx)
80103bee:	e8 ad e8 ff ff       	call   801024a0 <kfree>
    np->kstack = 0;
80103bf3:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103bfa:	83 c4 10             	add    $0x10,%esp
    np->state = UNUSED;
80103bfd:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return -1;
...
80103c4e:	66 90                	xchg   %ax,%ax
      if(p->state != RUNNABLE)
80103c50:	83 7b 10 03          	cmpl   $0x3,0x10(%ebx)
...
80103c65:	58                   	pop    %eax
80103c66:	5a                   	pop    %edx
80103c67:	ff 73 20             	push   0x20(%ebx)
80103c6a:	57                   	push   %edi
      p->state = RUNNING;
80103c6b:	c7 43 10 04 00 00 00 	movl   $0x4,0x10(%ebx)
      swtch(&(c->scheduler), p->context);
...
80103c8c:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
...
80103cea:	75 68                	jne    80103d54 <sched+0xa4>
  if(p->state == RUNNING)
80103cec:	83 7b 10 04          	cmpl   $0x4,0x10(%ebx)
...
80103cfe:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
...
80103d79:	e8 e2 fb ff ff       	call   80103960 <myproc>
  if(curproc == initproc)
80103d7e:	39 05 54 3d 11 80    	cmp    %eax,0x80113d54
80103d84:	0f 84 fd 00 00 00    	je     80103e87 <exit+0x117>
80103d8a:	89 c3                	mov    %eax,%ebx
80103d8c:	8d 70 2c             	lea    0x2c(%eax),%esi
80103d8f:	8d 78 6c             	lea    0x6c(%eax),%edi
...
80103df3:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80103df8:	74 1c                	je     80103e16 <exit+0xa6>
    if(p->state == SLEEPING && p->chan == chan)
80103dfa:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80103dfe:	75 f0                	jne    80103df0 <exit+0x80>
80103e00:	3b 50 24             	cmp    0x24(%eax),%edx
80103e03:	75 eb                	jne    80103df0 <exit+0x80>
      p->state = RUNNABLE;
80103e05:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e0c:	83 e8 80             	sub    $0xffffff80,%eax
80103e0f:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80103e14:	75 e4                	jne    80103dfa <exit+0x8a>
      p->parent = initproc;
80103e16:	8b 0d 54 3d 11 80    	mov    0x80113d54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103e2b:	81 fa 54 3d 11 80    	cmp    $0x80113d54,%edx
80103e31:	74 3b                	je     80103e6e <exit+0xfe>
    if(p->parent == curproc){
80103e33:	39 5a 18             	cmp    %ebx,0x18(%edx)
80103e36:	75 f0                	jne    80103e28 <exit+0xb8>
      if(p->state == ZOMBIE)
80103e38:	83 7a 10 05          	cmpl   $0x5,0x10(%edx)
      p->parent = initproc;
80103e3c:	89 4a 18             	mov    %ecx,0x18(%edx)
      if(p->state == ZOMBIE)
...
80103edb:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
...
80103f28:	0f 84 8f 00 00 00    	je     80103fbd <wait+0x11d>
  p->chan = chan;
80103f2e:	89 73 24             	mov    %esi,0x24(%ebx)
  p->state = SLEEPING;
80103f31:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
80103f38:	e8 73 fd ff ff       	call   80103cb0 <sched>
  p->chan = 0;
80103f3d:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
}
...
80103f50:	83 ec 0c             	sub    $0xc,%esp
        pid = p->pid;
80103f53:	8b 73 14             	mov    0x14(%ebx),%esi
        kfree(p->kstack);
80103f56:	ff 73 0c             	push   0xc(%ebx)
...
80103f6e:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
80103f75:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
80103f7c:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80103f80:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
80103f87:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        release(&ptable.lock);
...
80103ff6:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  sched();
...
80104068:	e8 d3 04 00 00       	call   80104540 <release>
  p->chan = chan;
8010406d:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
80104070:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
...
801040a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  p->chan = chan;
801040a8:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
801040ab:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
...
8010411f:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
...
80104168:	74 36                	je     801041a0 <kill+0x60>
    if(p->pid == pid){
8010416a:	39 58 14             	cmp    %ebx,0x14(%eax)
8010416d:	75 f1                	jne    80104160 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
8010416f:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
      p->killed = 1;
80104173:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING)
8010417a:	75 07                	jne    80104183 <kill+0x43>
        p->state = RUNNABLE;
8010417c:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
      release(&ptable.lock);
...
801041c9:	bb c4 1d 11 80       	mov    $0x80111dc4,%ebx
...
80104208:	8b 14 85 80 7a 10 80 	mov    -0x7fef8580(,%eax,4),%edx
      state = "???";
...
801049b8:	8b 40 1c             	mov    0x1c(%eax),%eax
...
80104a1d:	8b 40 1c             	mov    0x1c(%eax),%eax
...
80104a9c:	89 c3                	mov    %eax,%ebx
  ...
  num = curproc->tf->eax;
80104a9e:	8b 40 1c             	mov    0x1c(%eax),%eax
...
80104ad0:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104ad1:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104ad4:	50                   	push   %eax
80104ad5:	ff 73 14             	push   0x14(%ebx)
80104ad8:	68 11 75 10 80       	push   $0x80107511
80104add:	e8 ce bb ff ff       	call   801006b0 <cprintf>
    curproc->tf->eax = -1;
80104ae2:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104c24:	68 49 75 10 80       	push   $0x80107549
...
80104c3c:	68 48 75 10 80       	push   $0x80107548
...
80104ca8:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
80104cc0:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
80104ce0:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80104ce3:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
...
80104d28:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
80104e2b:	8b 74 98 0c          	mov    0xc(%eax,%ebx,4),%esi
...
80104e38:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104e3b:	c7 44 98 0c 00 00 00 	movl   $0x0,0xc(%eax,%ebx,4)
80104e42:	00 
  fileclose(f);
...
80104e88:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
801052c0:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
801052c3:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
...
801055ed:	e8 6e e3 ff ff       	call   80103960 <myproc>
    if(curproc->ofile[fd] == 0){
801055f2:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
...
80105606:	74 3d                	je     80105645 <sys_pipe+0x95>
    if(curproc->ofile[fd] == 0){
80105608:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
...
8010570b:	8b 40 14             	mov    0x14(%eax),%eax
}
8010570e:	c9                   	leave
8010570f:	c3                   	ret
...
8010577c:	68 80 3d 11 80       	push   $0x80113d80
80105781:	e8 1a ee ff ff       	call   801045a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105786:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105789:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  while(ticks - ticks0 < n){
...
801057c6:	8b 40 28             	mov    0x28(%eax),%eax
...
80105846:	e8 15 e1 ff ff       	call   80103960 <myproc>
8010584b:	8b 40 18             	mov    0x18(%eax),%eax
...
801058b7:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
801058be:	08 00 00 8e 
801058c2:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
801058c9:	80 
801058ca:	c1 ea 10             	shr    $0x10,%edx
801058cd:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
801058d4:	80 
  for(i = 0; i < 256; i++)
...
801058e7:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
801058ee:	00 00 ef 
  initlock(&tickslock, "time");
801058f1:	68 8e 75 10 80       	push   $0x8010758e
801058f6:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801058fb:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
80105901:	c1 e8 10             	shr    $0x10,%eax
80105904:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
...
8010592b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010592f:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105974:	ff 24 85 00 7b 10 80 	jmp    *-0x7fef8500(,%eax,4)
...
80105998:	8b 50 28             	mov    0x28(%eax),%edx
...
801059bb:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
...
801059d3:	8b 40 28             	mov    0x28(%eax),%eax
...
80105a3e:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105a41:	56                   	push   %esi
80105a42:	ff 70 14             	push   0x14(%eax)
80105a45:	68 dc 77 10 80       	push   $0x801077dc
...
80105a97:	68 84 77 10 80       	push   $0x80107784
...
80105ac5:	8b 70 28             	mov    0x28(%eax),%esi
...
80105b55:	e8 46 ea ff ff       	call   801045a0 <acquire>
      ticks++;
80105b5a:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105b61:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
80105b68:	e8 73 e5 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105b6d:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
...
80105bb3:	68 a8 77 10 80       	push   $0x801077a8
80105bb8:	e8 f3 aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105bbd:	83 c4 14             	add    $0x14,%esp
80105bc0:	68 93 75 10 80       	push   $0x80107593
...
{
  if(!uart)
80105bd0:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105c57:	0f 84 7c 00 00 00    	je     80105cd9 <uartinit+0xd9>
  uart = 1;
80105c5d:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105c64:	00 00 00 
...
80105c70:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c73:	bf 98 75 10 80       	mov    $0x80107598,%edi
...
80105c8d:	8d 76 00             	lea    0x0(%esi),%esi
  if(!uart)
80105c90:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105cf0 <uartputc>:
  if(!uart)
80105cf0:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105d67:	6a 00                	push   $0x0
  jmp alltraps
80105d69:	e9 02 fb ff ff       	jmp    80105870 <alltraps>
...
80105d70:	6a 01                	push   $0x1
  jmp alltraps
80105d72:	e9 f9 fa ff ff       	jmp    80105870 <alltraps>
...
80105d79:	6a 02                	push   $0x2
  jmp alltraps
80105d7b:	e9 f0 fa ff ff       	jmp    80105870 <alltraps>
...
80105d82:	6a 03                	push   $0x3
  jmp alltraps
80105d84:	e9 e7 fa ff ff       	jmp    80105870 <alltraps>
...
80105d8b:	6a 04                	push   $0x4
  jmp alltraps
80105d8d:	e9 de fa ff ff       	jmp    80105870 <alltraps>
...
80105d94:	6a 05                	push   $0x5
  jmp alltraps
80105d96:	e9 d5 fa ff ff       	jmp    80105870 <alltraps>
...
80105db6:	6a 09                	push   $0x9
  jmp alltraps
80105db8:	e9 b3 fa ff ff       	jmp    80105870 <alltraps>
...
80105dbd:	6a 0a                	push   $0xa
  jmp alltraps
80105dbf:	e9 ac fa ff ff       	jmp    80105870 <alltraps>
...
80105dc4:	6a 0b                	push   $0xb
  jmp alltraps
80105dc6:	e9 a5 fa ff ff       	jmp    80105870 <alltraps>
...
80105dcb:	6a 0c                	push   $0xc
  jmp alltraps
80105dcd:	e9 9e fa ff ff       	jmp    80105870 <alltraps>
...
80105dd9:	6a 0e                	push   $0xe
  jmp alltraps
80105ddb:	e9 90 fa ff ff       	jmp    80105870 <alltraps>
...
80105df2:	6a 11                	push   $0x11
  jmp alltraps
80105df4:	e9 77 fa ff ff       	jmp    80105870 <alltraps>
...
80105dfb:	6a 12                	push   $0x12
  jmp alltraps
80105dfd:	e9 6e fa ff ff       	jmp    80105870 <alltraps>
...
80105e04:	6a 13                	push   $0x13
  jmp alltraps
80105e06:	e9 65 fa ff ff       	jmp    80105870 <alltraps>
...
80105e0d:	6a 14                	push   $0x14
  jmp alltraps
80105e0f:	e9 5c fa ff ff       	jmp    80105870 <alltraps>
...
80105e16:	6a 15                	push   $0x15
  jmp alltraps
80105e18:	e9 53 fa ff ff       	jmp    80105870 <alltraps>
...
80105e1f:	6a 16                	push   $0x16
  jmp alltraps
80105e21:	e9 4a fa ff ff       	jmp    80105870 <alltraps>
...
80105e28:	6a 17                	push   $0x17
  jmp alltraps
80105e2a:	e9 41 fa ff ff       	jmp    80105870 <alltraps>
...
80105e31:	6a 18                	push   $0x18
  jmp alltraps
80105e33:	e9 38 fa ff ff       	jmp    80105870 <alltraps>
...
80105e3a:	6a 19                	push   $0x19
  jmp alltraps
80105e3c:	e9 2f fa ff ff       	jmp    80105870 <alltraps>
...
80105e43:	6a 1a                	push   $0x1a
  jmp alltraps
80105e45:	e9 26 fa ff ff       	jmp    80105870 <alltraps>
...
80105e4c:	6a 1b                	push   $0x1b
  jmp alltraps
80105e4e:	e9 1d fa ff ff       	jmp    80105870 <alltraps>
...
80105e55:	6a 1c                	push   $0x1c
  jmp alltraps
80105e57:	e9 14 fa ff ff       	jmp    80105870 <alltraps>
...
80105e5e:	6a 1d                	push   $0x1d
  jmp alltraps
80105e60:	e9 0b fa ff ff       	jmp    80105870 <alltraps>
...
80105e67:	6a 1e                	push   $0x1e
  jmp alltraps
80105e69:	e9 02 fa ff ff       	jmp    80105870 <alltraps>
...
80105e70:	6a 1f                	push   $0x1f
  jmp alltraps
80105e72:	e9 f9 f9 ff ff       	jmp    80105870 <alltraps>
...
80105e79:	6a 20                	push   $0x20
  jmp alltraps
80105e7b:	e9 f0 f9 ff ff       	jmp    80105870 <alltraps>
...
80105e82:	6a 21                	push   $0x21
  jmp alltraps
80105e84:	e9 e7 f9 ff ff       	jmp    80105870 <alltraps>
...
80105e8b:	6a 22                	push   $0x22
  jmp alltraps
80105e8d:	e9 de f9 ff ff       	jmp    80105870 <alltraps>
...
80105e94:	6a 23                	push   $0x23
  jmp alltraps
80105e96:	e9 d5 f9 ff ff       	jmp    80105870 <alltraps>
...
80105e9d:	6a 24                	push   $0x24
  jmp alltraps
80105e9f:	e9 cc f9 ff ff       	jmp    80105870 <alltraps>
...
80105ea6:	6a 25                	push   $0x25
  jmp alltraps
80105ea8:	e9 c3 f9 ff ff       	jmp    80105870 <alltraps>
...
80105eaf:	6a 26                	push   $0x26
  jmp alltraps
80105eb1:	e9 ba f9 ff ff       	jmp    80105870 <alltraps>
...
80105eb8:	6a 27                	push   $0x27
  jmp alltraps
80105eba:	e9 b1 f9 ff ff       	jmp    80105870 <alltraps>
...
80105ec1:	6a 28                	push   $0x28
  jmp alltraps
80105ec3:	e9 a8 f9 ff ff       	jmp    80105870 <alltraps>
...
80105eca:	6a 29                	push   $0x29
  jmp alltraps
80105ecc:	e9 9f f9 ff ff       	jmp    80105870 <alltraps>
...
80105ed3:	6a 2a                	push   $0x2a
  jmp alltraps
80105ed5:	e9 96 f9 ff ff       	jmp    80105870 <alltraps>
...
80105edc:	6a 2b                	push   $0x2b
  jmp alltraps
80105ede:	e9 8d f9 ff ff       	jmp    80105870 <alltraps>
...
80105ee5:	6a 2c                	push   $0x2c
  jmp alltraps
80105ee7:	e9 84 f9 ff ff       	jmp    80105870 <alltraps>
...
80105eee:	6a 2d                	push   $0x2d
  jmp alltraps
80105ef0:	e9 7b f9 ff ff       	jmp    80105870 <alltraps>
...
80105ef7:	6a 2e                	push   $0x2e
  jmp alltraps
80105ef9:	e9 72 f9 ff ff       	jmp    80105870 <alltraps>
...
80105f00:	6a 2f                	push   $0x2f
  jmp alltraps
80105f02:	e9 69 f9 ff ff       	jmp    80105870 <alltraps>
...
80105f09:	6a 30                	push   $0x30
  jmp alltraps
80105f0b:	e9 60 f9 ff ff       	jmp    80105870 <alltraps>
...
80105f12:	6a 31                	push   $0x31
  jmp alltraps
80105f14:	e9 57 f9 ff ff       	jmp    80105870 <alltraps>
...
80105f1b:	6a 32                	push   $0x32
  jmp alltraps
80105f1d:	e9 4e f9 ff ff       	jmp    80105870 <alltraps>
...
80105f24:	6a 33                	push   $0x33
  jmp alltraps
80105f26:	e9 45 f9 ff ff       	jmp    80105870 <alltraps>
...
80105f2d:	6a 34                	push   $0x34
  jmp alltraps
80105f2f:	e9 3c f9 ff ff       	jmp    80105870 <alltraps>
...
80105f36:	6a 35                	push   $0x35
  jmp alltraps
80105f38:	e9 33 f9 ff ff       	jmp    80105870 <alltraps>
...
80105f3f:	6a 36                	push   $0x36
  jmp alltraps
80105f41:	e9 2a f9 ff ff       	jmp    80105870 <alltraps>
...
80105f48:	6a 37                	push   $0x37
  jmp alltraps
80105f4a:	e9 21 f9 ff ff       	jmp    80105870 <alltraps>
...
80105f51:	6a 38                	push   $0x38
  jmp alltraps
80105f53:	e9 18 f9 ff ff       	jmp    80105870 <alltraps>
...
80105f5a:	6a 39                	push   $0x39
  jmp alltraps
80105f5c:	e9 0f f9 ff ff       	jmp    80105870 <alltraps>
...
80105f63:	6a 3a                	push   $0x3a
  jmp alltraps
80105f65:	e9 06 f9 ff ff       	jmp    80105870 <alltraps>
...
80105f6c:	6a 3b                	push   $0x3b
  jmp alltraps
80105f6e:	e9 fd f8 ff ff       	jmp    80105870 <alltraps>
...
80105f75:	6a 3c                	push   $0x3c
  jmp alltraps
80105f77:	e9 f4 f8 ff ff       	jmp    80105870 <alltraps>
...
80105f7e:	6a 3d                	push   $0x3d
  jmp alltraps
80105f80:	e9 eb f8 ff ff       	jmp    80105870 <alltraps>
...
80105f87:	6a 3e                	push   $0x3e
  jmp alltraps
80105f89:	e9 e2 f8 ff ff       	jmp    80105870 <alltraps>
...
80105f90:	6a 3f                	push   $0x3f
  jmp alltraps
80105f92:	e9 d9 f8 ff ff       	jmp    80105870 <alltraps>
...
80105f99:	6a 40                	push   $0x40
  jmp alltraps
80105f9b:	e9 d0 f8 ff ff       	jmp    80105870 <alltraps>
...
80105fa2:	6a 41                	push   $0x41
  jmp alltraps
80105fa4:	e9 c7 f8 ff ff       	jmp    80105870 <alltraps>
...
80105fab:	6a 42                	push   $0x42
  jmp alltraps
80105fad:	e9 be f8 ff ff       	jmp    80105870 <alltraps>
...
80105fb4:	6a 43                	push   $0x43
  jmp alltraps
80105fb6:	e9 b5 f8 ff ff       	jmp    80105870 <alltraps>
...
80105fbd:	6a 44                	push   $0x44
  jmp alltraps
80105fbf:	e9 ac f8 ff ff       	jmp    80105870 <alltraps>
...
80105fc6:	6a 45                	push   $0x45
  jmp alltraps
80105fc8:	e9 a3 f8 ff ff       	jmp    80105870 <alltraps>
...
80105fcf:	6a 46                	push   $0x46
  jmp alltraps
80105fd1:	e9 9a f8 ff ff       	jmp    80105870 <alltraps>
...
80105fd8:	6a 47                	push   $0x47
  jmp alltraps
80105fda:	e9 91 f8 ff ff       	jmp    80105870 <alltraps>
...
80105fe1:	6a 48                	push   $0x48
  jmp alltraps
80105fe3:	e9 88 f8 ff ff       	jmp    80105870 <alltraps>
...
80105fea:	6a 49                	push   $0x49
  jmp alltraps
80105fec:	e9 7f f8 ff ff       	jmp    80105870 <alltraps>
...
80105ff3:	6a 4a                	push   $0x4a
  jmp alltraps
80105ff5:	e9 76 f8 ff ff       	jmp    80105870 <alltraps>
...
80105ffc:	6a 4b                	push   $0x4b
  jmp alltraps
80105ffe:	e9 6d f8 ff ff       	jmp    80105870 <alltraps>
...
80106005:	6a 4c                	push   $0x4c
  jmp alltraps
80106007:	e9 64 f8 ff ff       	jmp    80105870 <alltraps>
...
8010600e:	6a 4d                	push   $0x4d
  jmp alltraps
80106010:	e9 5b f8 ff ff       	jmp    80105870 <alltraps>
...
80106017:	6a 4e                	push   $0x4e
  jmp alltraps
80106019:	e9 52 f8 ff ff       	jmp    80105870 <alltraps>
...
80106020:	6a 4f                	push   $0x4f
  jmp alltraps
80106022:	e9 49 f8 ff ff       	jmp    80105870 <alltraps>
...
80106029:	6a 50                	push   $0x50
  jmp alltraps
8010602b:	e9 40 f8 ff ff       	jmp    80105870 <alltraps>
...
80106032:	6a 51                	push   $0x51
  jmp alltraps
80106034:	e9 37 f8 ff ff       	jmp    80105870 <alltraps>
...
8010603b:	6a 52                	push   $0x52
  jmp alltraps
8010603d:	e9 2e f8 ff ff       	jmp    80105870 <alltraps>
...
80106044:	6a 53                	push   $0x53
  jmp alltraps
80106046:	e9 25 f8 ff ff       	jmp    80105870 <alltraps>
...
8010604d:	6a 54                	push   $0x54
  jmp alltraps
8010604f:	e9 1c f8 ff ff       	jmp    80105870 <alltraps>
...
80106056:	6a 55                	push   $0x55
  jmp alltraps
80106058:	e9 13 f8 ff ff       	jmp    80105870 <alltraps>
...
8010605f:	6a 56                	push   $0x56
  jmp alltraps
80106061:	e9 0a f8 ff ff       	jmp    80105870 <alltraps>
...
80106068:	6a 57                	push   $0x57
  jmp alltraps
8010606a:	e9 01 f8 ff ff       	jmp    80105870 <alltraps>
...
80106071:	6a 58                	push   $0x58
  jmp alltraps
80106073:	e9 f8 f7 ff ff       	jmp    80105870 <alltraps>
...
8010607a:	6a 59                	push   $0x59
  jmp alltraps
8010607c:	e9 ef f7 ff ff       	jmp    80105870 <alltraps>
...
80106083:	6a 5a                	push   $0x5a
  jmp alltraps
80106085:	e9 e6 f7 ff ff       	jmp    80105870 <alltraps>
...
8010608c:	6a 5b                	push   $0x5b
  jmp alltraps
8010608e:	e9 dd f7 ff ff       	jmp    80105870 <alltraps>
...
80106095:	6a 5c                	push   $0x5c
  jmp alltraps
80106097:	e9 d4 f7 ff ff       	jmp    80105870 <alltraps>
...
8010609e:	6a 5d                	push   $0x5d
  jmp alltraps
801060a0:	e9 cb f7 ff ff       	jmp    80105870 <alltraps>
...
801060a7:	6a 5e                	push   $0x5e
  jmp alltraps
801060a9:	e9 c2 f7 ff ff       	jmp    80105870 <alltraps>
...
801060b0:	6a 5f                	push   $0x5f
  jmp alltraps
801060b2:	e9 b9 f7 ff ff       	jmp    80105870 <alltraps>
...
801060b9:	6a 60                	push   $0x60
  jmp alltraps
801060bb:	e9 b0 f7 ff ff       	jmp    80105870 <alltraps>
...
801060c2:	6a 61                	push   $0x61
  jmp alltraps
801060c4:	e9 a7 f7 ff ff       	jmp    80105870 <alltraps>
...
801060cb:	6a 62                	push   $0x62
  jmp alltraps
801060cd:	e9 9e f7 ff ff       	jmp    80105870 <alltraps>
...
801060d4:	6a 63                	push   $0x63
  jmp alltraps
801060d6:	e9 95 f7 ff ff       	jmp    80105870 <alltraps>
...
801060dd:	6a 64                	push   $0x64
  jmp alltraps
801060df:	e9 8c f7 ff ff       	jmp    80105870 <alltraps>
...
801060e6:	6a 65                	push   $0x65
  jmp alltraps
801060e8:	e9 83 f7 ff ff       	jmp    80105870 <alltraps>
...
801060ef:	6a 66                	push   $0x66
  jmp alltraps
801060f1:	e9 7a f7 ff ff       	jmp    80105870 <alltraps>
...
801060f8:	6a 67                	push   $0x67
  jmp alltraps
801060fa:	e9 71 f7 ff ff       	jmp    80105870 <alltraps>
...
80106101:	6a 68                	push   $0x68
  jmp alltraps
80106103:	e9 68 f7 ff ff       	jmp    80105870 <alltraps>
...
8010610a:	6a 69                	push   $0x69
  jmp alltraps
8010610c:	e9 5f f7 ff ff       	jmp    80105870 <alltraps>
...
80106113:	6a 6a                	push   $0x6a
  jmp alltraps
80106115:	e9 56 f7 ff ff       	jmp    80105870 <alltraps>
...
8010611c:	6a 6b                	push   $0x6b
  jmp alltraps
8010611e:	e9 4d f7 ff ff       	jmp    80105870 <alltraps>
...
80106125:	6a 6c                	push   $0x6c
  jmp alltraps
80106127:	e9 44 f7 ff ff       	jmp    80105870 <alltraps>
...
8010612e:	6a 6d                	push   $0x6d
  jmp alltraps
80106130:	e9 3b f7 ff ff       	jmp    80105870 <alltraps>
...
80106137:	6a 6e                	push   $0x6e
  jmp alltraps
80106139:	e9 32 f7 ff ff       	jmp    80105870 <alltraps>
...
80106140:	6a 6f                	push   $0x6f
  jmp alltraps
80106142:	e9 29 f7 ff ff       	jmp    80105870 <alltraps>
...
80106149:	6a 70                	push   $0x70
  jmp alltraps
8010614b:	e9 20 f7 ff ff       	jmp    80105870 <alltraps>
...
80106152:	6a 71                	push   $0x71
  jmp alltraps
80106154:	e9 17 f7 ff ff       	jmp    80105870 <alltraps>
...
8010615b:	6a 72                	push   $0x72
  jmp alltraps
8010615d:	e9 0e f7 ff ff       	jmp    80105870 <alltraps>
...
80106164:	6a 73                	push   $0x73
  jmp alltraps
80106166:	e9 05 f7 ff ff       	jmp    80105870 <alltraps>
...
8010616d:	6a 74                	push   $0x74
  jmp alltraps
8010616f:	e9 fc f6 ff ff       	jmp    80105870 <alltraps>
...
80106176:	6a 75                	push   $0x75
  jmp alltraps
80106178:	e9 f3 f6 ff ff       	jmp    80105870 <alltraps>
...
8010617f:	6a 76                	push   $0x76
  jmp alltraps
80106181:	e9 ea f6 ff ff       	jmp    80105870 <alltraps>
...
80106188:	6a 77                	push   $0x77
  jmp alltraps
8010618a:	e9 e1 f6 ff ff       	jmp    80105870 <alltraps>
...
80106191:	6a 78                	push   $0x78
  jmp alltraps
80106193:	e9 d8 f6 ff ff       	jmp    80105870 <alltraps>
...
8010619a:	6a 79                	push   $0x79
  jmp alltraps
8010619c:	e9 cf f6 ff ff       	jmp    80105870 <alltraps>
...
801061a3:	6a 7a                	push   $0x7a
  jmp alltraps
801061a5:	e9 c6 f6 ff ff       	jmp    80105870 <alltraps>
...
801061ac:	6a 7b                	push   $0x7b
  jmp alltraps
801061ae:	e9 bd f6 ff ff       	jmp    80105870 <alltraps>
...
801061b5:	6a 7c                	push   $0x7c
  jmp alltraps
801061b7:	e9 b4 f6 ff ff       	jmp    80105870 <alltraps>
...
801061be:	6a 7d                	push   $0x7d
  jmp alltraps
801061c0:	e9 ab f6 ff ff       	jmp    80105870 <alltraps>
...
801061c7:	6a 7e                	push   $0x7e
  jmp alltraps
801061c9:	e9 a2 f6 ff ff       	jmp    80105870 <alltraps>
...
801061d0:	6a 7f                	push   $0x7f
  jmp alltraps
801061d2:	e9 99 f6 ff ff       	jmp    80105870 <alltraps>
...
801061d9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801061de:	e9 8d f6 ff ff       	jmp    80105870 <alltraps>
...
801061e5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801061ea:	e9 81 f6 ff ff       	jmp    80105870 <alltraps>
...
801061f1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801061f6:	e9 75 f6 ff ff       	jmp    80105870 <alltraps>
...
801061fd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106202:	e9 69 f6 ff ff       	jmp    80105870 <alltraps>
...
80106209:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010620e:	e9 5d f6 ff ff       	jmp    80105870 <alltraps>
...
80106215:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010621a:	e9 51 f6 ff ff       	jmp    80105870 <alltraps>
...
80106221:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106226:	e9 45 f6 ff ff       	jmp    80105870 <alltraps>
...
8010622d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106232:	e9 39 f6 ff ff       	jmp    80105870 <alltraps>
...
80106239:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010623e:	e9 2d f6 ff ff       	jmp    80105870 <alltraps>
...
80106245:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010624a:	e9 21 f6 ff ff       	jmp    80105870 <alltraps>
...
80106251:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106256:	e9 15 f6 ff ff       	jmp    80105870 <alltraps>
...
8010625d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106262:	e9 09 f6 ff ff       	jmp    80105870 <alltraps>
...
80106269:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010626e:	e9 fd f5 ff ff       	jmp    80105870 <alltraps>
...
80106275:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010627a:	e9 f1 f5 ff ff       	jmp    80105870 <alltraps>
...
80106281:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106286:	e9 e5 f5 ff ff       	jmp    80105870 <alltraps>
...
8010628d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106292:	e9 d9 f5 ff ff       	jmp    80105870 <alltraps>
...
80106299:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010629e:	e9 cd f5 ff ff       	jmp    80105870 <alltraps>
...
801062a5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801062aa:	e9 c1 f5 ff ff       	jmp    80105870 <alltraps>
...
801062b1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801062b6:	e9 b5 f5 ff ff       	jmp    80105870 <alltraps>
...
801062bd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801062c2:	e9 a9 f5 ff ff       	jmp    80105870 <alltraps>
...
801062c9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801062ce:	e9 9d f5 ff ff       	jmp    80105870 <alltraps>
...
801062d5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801062da:	e9 91 f5 ff ff       	jmp    80105870 <alltraps>
...
801062e1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801062e6:	e9 85 f5 ff ff       	jmp    80105870 <alltraps>
...
801062ed:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801062f2:	e9 79 f5 ff ff       	jmp    80105870 <alltraps>
...
801062f9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801062fe:	e9 6d f5 ff ff       	jmp    80105870 <alltraps>
...
80106305:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010630a:	e9 61 f5 ff ff       	jmp    80105870 <alltraps>
...
80106311:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106316:	e9 55 f5 ff ff       	jmp    80105870 <alltraps>
...
8010631d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106322:	e9 49 f5 ff ff       	jmp    80105870 <alltraps>
...
80106329:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010632e:	e9 3d f5 ff ff       	jmp    80105870 <alltraps>
...
80106335:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010633a:	e9 31 f5 ff ff       	jmp    80105870 <alltraps>
...
80106341:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106346:	e9 25 f5 ff ff       	jmp    80105870 <alltraps>
...
8010634d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106352:	e9 19 f5 ff ff       	jmp    80105870 <alltraps>
...
80106359:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010635e:	e9 0d f5 ff ff       	jmp    80105870 <alltraps>
...
80106365:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010636a:	e9 01 f5 ff ff       	jmp    80105870 <alltraps>
...
80106371:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106376:	e9 f5 f4 ff ff       	jmp    80105870 <alltraps>
...
8010637d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106382:	e9 e9 f4 ff ff       	jmp    80105870 <alltraps>
...
80106389:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010638e:	e9 dd f4 ff ff       	jmp    80105870 <alltraps>
...
80106395:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010639a:	e9 d1 f4 ff ff       	jmp    80105870 <alltraps>
...
801063a1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801063a6:	e9 c5 f4 ff ff       	jmp    80105870 <alltraps>
...
801063ad:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801063b2:	e9 b9 f4 ff ff       	jmp    80105870 <alltraps>
...
801063b9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801063be:	e9 ad f4 ff ff       	jmp    80105870 <alltraps>
...
801063c5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801063ca:	e9 a1 f4 ff ff       	jmp    80105870 <alltraps>
...
801063d1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801063d6:	e9 95 f4 ff ff       	jmp    80105870 <alltraps>
...
801063dd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801063e2:	e9 89 f4 ff ff       	jmp    80105870 <alltraps>
...
801063e9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801063ee:	e9 7d f4 ff ff       	jmp    80105870 <alltraps>
...
801063f5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801063fa:	e9 71 f4 ff ff       	jmp    80105870 <alltraps>
...
80106401:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106406:	e9 65 f4 ff ff       	jmp    80105870 <alltraps>
...
8010640d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106412:	e9 59 f4 ff ff       	jmp    80105870 <alltraps>
...
80106419:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010641e:	e9 4d f4 ff ff       	jmp    80105870 <alltraps>
...
80106425:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010642a:	e9 41 f4 ff ff       	jmp    80105870 <alltraps>
...
80106431:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106436:	e9 35 f4 ff ff       	jmp    80105870 <alltraps>
...
8010643d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106442:	e9 29 f4 ff ff       	jmp    80105870 <alltraps>
...
80106449:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010644e:	e9 1d f4 ff ff       	jmp    80105870 <alltraps>
...
80106455:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010645a:	e9 11 f4 ff ff       	jmp    80105870 <alltraps>
...
80106461:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106466:	e9 05 f4 ff ff       	jmp    80105870 <alltraps>
...
8010646d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106472:	e9 f9 f3 ff ff       	jmp    80105870 <alltraps>
...
80106479:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010647e:	e9 ed f3 ff ff       	jmp    80105870 <alltraps>
...
80106485:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010648a:	e9 e1 f3 ff ff       	jmp    80105870 <alltraps>
...
80106491:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106496:	e9 d5 f3 ff ff       	jmp    80105870 <alltraps>
...
8010649d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801064a2:	e9 c9 f3 ff ff       	jmp    80105870 <alltraps>
...
801064a9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801064ae:	e9 bd f3 ff ff       	jmp    80105870 <alltraps>
...
801064b5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801064ba:	e9 b1 f3 ff ff       	jmp    80105870 <alltraps>
...
801064c1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801064c6:	e9 a5 f3 ff ff       	jmp    80105870 <alltraps>
...
801064cd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801064d2:	e9 99 f3 ff ff       	jmp    80105870 <alltraps>
...
801064d9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801064de:	e9 8d f3 ff ff       	jmp    80105870 <alltraps>
...
801064e5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801064ea:	e9 81 f3 ff ff       	jmp    80105870 <alltraps>
...
801064f1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801064f6:	e9 75 f3 ff ff       	jmp    80105870 <alltraps>
...
801064fd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106502:	e9 69 f3 ff ff       	jmp    80105870 <alltraps>
...
80106509:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010650e:	e9 5d f3 ff ff       	jmp    80105870 <alltraps>
...
80106515:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010651a:	e9 51 f3 ff ff       	jmp    80105870 <alltraps>
...
80106521:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106526:	e9 45 f3 ff ff       	jmp    80105870 <alltraps>
...
8010652d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106532:	e9 39 f3 ff ff       	jmp    80105870 <alltraps>
...
80106539:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010653e:	e9 2d f3 ff ff       	jmp    80105870 <alltraps>
...
80106545:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010654a:	e9 21 f3 ff ff       	jmp    80105870 <alltraps>
...
80106551:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106556:	e9 15 f3 ff ff       	jmp    80105870 <alltraps>
...
8010655d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106562:	e9 09 f3 ff ff       	jmp    80105870 <alltraps>
...
80106569:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010656e:	e9 fd f2 ff ff       	jmp    80105870 <alltraps>
...
80106575:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010657a:	e9 f1 f2 ff ff       	jmp    80105870 <alltraps>
...
80106581:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106586:	e9 e5 f2 ff ff       	jmp    80105870 <alltraps>
...
8010658d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106592:	e9 d9 f2 ff ff       	jmp    80105870 <alltraps>
...
80106599:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010659e:	e9 cd f2 ff ff       	jmp    80105870 <alltraps>
...
801065a5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801065aa:	e9 c1 f2 ff ff       	jmp    80105870 <alltraps>
...
801065b1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801065b6:	e9 b5 f2 ff ff       	jmp    80105870 <alltraps>
...
801065bd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801065c2:	e9 a9 f2 ff ff       	jmp    80105870 <alltraps>
...
801065c9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801065ce:	e9 9d f2 ff ff       	jmp    80105870 <alltraps>
...
801065d5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801065da:	e9 91 f2 ff ff       	jmp    80105870 <alltraps>
...
801065e1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801065e6:	e9 85 f2 ff ff       	jmp    80105870 <alltraps>
...
801065ed:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801065f2:	e9 79 f2 ff ff       	jmp    80105870 <alltraps>
...
801065f9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801065fe:	e9 6d f2 ff ff       	jmp    80105870 <alltraps>
...
80106605:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010660a:	e9 61 f2 ff ff       	jmp    80105870 <alltraps>
...
80106611:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106616:	e9 55 f2 ff ff       	jmp    80105870 <alltraps>
...
8010661d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106622:	e9 49 f2 ff ff       	jmp    80105870 <alltraps>
...
80106629:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010662e:	e9 3d f2 ff ff       	jmp    80105870 <alltraps>
...
80106635:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010663a:	e9 31 f2 ff ff       	jmp    80105870 <alltraps>
...
80106641:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106646:	e9 25 f2 ff ff       	jmp    80105870 <alltraps>
...
8010664d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106652:	e9 19 f2 ff ff       	jmp    80105870 <alltraps>
...
80106659:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010665e:	e9 0d f2 ff ff       	jmp    80105870 <alltraps>
...
80106665:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010666a:	e9 01 f2 ff ff       	jmp    80105870 <alltraps>
...
80106671:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106676:	e9 f5 f1 ff ff       	jmp    80105870 <alltraps>
...
8010667d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106682:	e9 e9 f1 ff ff       	jmp    80105870 <alltraps>
...
80106689:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010668e:	e9 dd f1 ff ff       	jmp    80105870 <alltraps>
...
80106695:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010669a:	e9 d1 f1 ff ff       	jmp    80105870 <alltraps>
...
801066a1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801066a6:	e9 c5 f1 ff ff       	jmp    80105870 <alltraps>
...
801066ad:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801066b2:	e9 b9 f1 ff ff       	jmp    80105870 <alltraps>
...
801066b9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801066be:	e9 ad f1 ff ff       	jmp    80105870 <alltraps>
...
801066c5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801066ca:	e9 a1 f1 ff ff       	jmp    80105870 <alltraps>
...
801066d1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801066d6:	e9 95 f1 ff ff       	jmp    80105870 <alltraps>
...
801066dd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801066e2:	e9 89 f1 ff ff       	jmp    80105870 <alltraps>
...
801066e9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801066ee:	e9 7d f1 ff ff       	jmp    80105870 <alltraps>
...
801066f5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801066fa:	e9 71 f1 ff ff       	jmp    80105870 <alltraps>
...
80106701:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106706:	e9 65 f1 ff ff       	jmp    80105870 <alltraps>
...
8010670d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106712:	e9 59 f1 ff ff       	jmp    80105870 <alltraps>
...
80106719:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010671e:	e9 4d f1 ff ff       	jmp    80105870 <alltraps>
...
80106725:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010672a:	e9 41 f1 ff ff       	jmp    80105870 <alltraps>
...
80106731:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106736:	e9 35 f1 ff ff       	jmp    80105870 <alltraps>
...
8010673d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106742:	e9 29 f1 ff ff       	jmp    80105870 <alltraps>
...
80106749:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010674e:	e9 1d f1 ff ff       	jmp    80105870 <alltraps>
...
80106755:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010675a:	e9 11 f1 ff ff       	jmp    80105870 <alltraps>
...
80106761:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106766:	e9 05 f1 ff ff       	jmp    80105870 <alltraps>
...
8010676d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106772:	e9 f9 f0 ff ff       	jmp    80105870 <alltraps>
...
80106779:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010677e:	e9 ed f0 ff ff       	jmp    80105870 <alltraps>
...
80106785:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010678a:	e9 e1 f0 ff ff       	jmp    80105870 <alltraps>
...
80106791:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106796:	e9 d5 f0 ff ff       	jmp    80105870 <alltraps>
...
8010679d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067a2:	e9 c9 f0 ff ff       	jmp    80105870 <alltraps>
...
801067a9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801067ae:	e9 bd f0 ff ff       	jmp    80105870 <alltraps>
...
801067b5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801067ba:	e9 b1 f0 ff ff       	jmp    80105870 <alltraps>
...
801067c1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801067c6:	e9 a5 f0 ff ff       	jmp    80105870 <alltraps>
...
801067cd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801067d2:	e9 99 f0 ff ff       	jmp    80105870 <alltraps>
...
8010697d:	68 a0 75 10 80       	push   $0x801075a0
...
80106a20:	a1 c4 45 11 80       	mov    0x801145c4,%eax
...
80106ad6:	8b 5e 0c             	mov    0xc(%esi),%ebx
...
80106ba9:	68 e5 75 10 80       	push   $0x801075e5
...
80106bf8:	68 ff 75 10 80       	push   $0x801075ff
...
80106c80:	68 20 78 10 80       	push   $0x80107820
...
80106d1d:	68 1d 76 10 80       	push   $0x8010761d
...
80106d63:	68 35 76 10 80       	push   $0x80107635
...
80106e4c:	68 51 76 10 80       	push   $0x80107651
...
80106eeb:	a3 c4 45 11 80       	mov    %eax,0x801145c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f1c:	68 62 76 10 80       	push   $0x80107662
...
80106f92:	68 6c 76 10 80       	push   $0x8010766c
...
80107067:	68 86 76 10 80       	push   $0x80107686
