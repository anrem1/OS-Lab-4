...
int main() {
  ...
  15:	e8 19 03 00 00       	call   333 <getppid>
...
printf(int fd, const char *fmt, ...)
{
 ...
 574:	eb 1a                	jmp    590 <printf+0x1a0>
          s = "(null)";
 576:	bb 72 07 00 00       	mov    $0x772,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c5:	a1 24 0a 00 00       	mov    0xa24,%eax
{
 ...
 5e6:	73 10                	jae    5f8 <free+0x38>
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	a3 24 0a 00 00       	mov    %eax,0xa24
}
 617:	5e                   	pop    %esi
 618:	5f                   	pop    %edi
 619:	5d                   	pop    %ebp
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 24 0a 00 00       	mov    %eax,0xa24
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 65d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 660:	8b 3d 24 0a 00 00    	mov    0xa24,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6a9:	8b 3d 24 0a 00 00    	mov    0xa24,%edi
 ...
 6d2:	e8 e9 fe ff ff       	call   5c0 <free>
  return freep;
 6d7:	a1 24 0a 00 00       	mov    0xa24,%eax
 ...
 704:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 707:	a3 24 0a 00 00       	mov    %eax,0xa24
}
 ...
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf 28 0a 00 00       	mov    $0xa28,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 28 0a 00 00 28 	movl   $0xa28,0xa28
 736:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 73b:	c7 05 2c 0a 00 00 00 	movl   $0x0,0xa2c
 742:	00 00 00 
    if(p->s.size >= nunits){
